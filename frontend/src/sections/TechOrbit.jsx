      ...
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative grid place-items-center h-[460px] sm:h-[520px]" data-testid="tech-orbit">
            ...
            <div className="relative z-10 h-24 w-24 rounded-3xl glass grid place-items-center glow-accent">
              <div className="font-display font-black text-2xl text-gradient">3C</div>
            </div>
